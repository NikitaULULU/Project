...
<body style="background-color:rgb(0, 0, 0);">
    <div class="form_container" style="background-color:rgb(97, 97, 97);">

    <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in']): ?>
    <div class="logout-container">
        <span style="color:rgb(255, 255, 255);">Welcome, <?= htmlspecialchars($_SESSION['user_login'] ?? 'User') ?></span>
...
<?php endif; ?>
        ...
        <form action="database.php" method="post">
            <label for="name" style="color:rgb(255, 255, 255);">Your Full Name</label>
            ...
            <label for="phone" style="color:rgb(255, 255, 255);">Phone number</label>
            ...
            <label for="mail" style="color:rgb(255, 255, 255);">Email</label>
            ...
            <label for="bdate" style="color:rgb(255, 255, 255);">Date of birth</label>
            ...
            <label for="gender_choice" style="color:rgb(255, 255, 255);">Gender</label>
            <div class="radio_container" id="gender_choice">
                <input type="radio" id="male" name="gender" value="male" 
                       <?= $form_data['gender'] === 'male' ? 'checked' : '' ?>
                       <?= $success ? 'disabled' : '' ?>>
                <label for="male" style="color:rgb(255, 255, 255);">Male</label>

                <input type="radio" id="female" name="gender" value="female" 
                       <?= $form_data['gender'] === 'female' ? 'checked' : '' ?>
                       <?= $success ? 'disabled' : '' ?>>
                <label for="female" style="color:rgb(255, 255, 255);">Female</label>
            </div>
            <?php if (isset($errors['gender'])): ?>
                <div class="error"><?= htmlspecialchars($errors['gender']) ?></div>
            <?php endif; ?>
    
            <label for="languages" style="color:rgb(255, 255, 255);">Programming Languages (Select multiple)</label>
            ...
            <label for="bio" style="color:rgb(255, 255, 255);">Write about yourself</label>
    ...
    <?= $success ? 'disabled' : '' ?>><?= htmlspecialchars(trim($form_data['bio'])) ?></textarea>
            ...
            <div class="chek_container">
                ...
                <label for="contract" style="color:rgb(255, 255, 255);">I've read and agree</label>
            </div>
